...
public class Main extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
		...
		// Register Commands
		this.getCommand("commandOne").setExecutor(new Commands());
		this.getCommand("commandTwo").setExecutor(new Commands());

		// Announce Successful Start
		getLogger().info("Project Name has successfully started!!!");
	}

	@Override
    public void onDisable() {
		getLogger().info("Thank you for using Project Name!!!");
	}
